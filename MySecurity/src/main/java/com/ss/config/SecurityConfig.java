...
import com.ss.response.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.antMatchers("/login","/api/employee/create", "/swagger-ui/**", "/swagger-ui", "/v2/api-docs/**", "/swagger-resources/**",
						"/swagger-ui.html/**", "/swagger-ui.html","/webjars/**","/null/swagger-resources/**")
				.permitAll()
...
//			.antMatchers("/home/hello","/token").permitAll()
